...
<p align="center">
  <a href="https://github.com/AgusPalombo/ETL-APP-CV/releases/download/v0.4.5/EasyETL-Setup.exe"><strong>Descargar EasyETL para Windows</strong></a>
</p>
...
1. Descargá [EasyETL-Setup.exe](https://github.com/AgusPalombo/ETL-APP-CV/releases/download/v0.4.5/EasyETL-Setup.exe).
...
La versión actual es **0.4.5 para Windows de 64 bits**.

### Novedades de la versión 0.4.5

- Icono de EasyETL recuperado en la bandeja oculta de Windows, con cierre completo desde `Salir`.
- Filtros plegables en Exploración y en ambos archivos de Comparación.
- Configuración de gráficos plegable y conservación del gráfico al navegar entre secciones.
- Tarjeta `Resultado Columna` estable al alternar entre varios archivos, con tiempo máximo y reintento.
- Mayor contraste en controles interactivos del modo oscuro.
