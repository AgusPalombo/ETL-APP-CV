...
<p align="center">
  <a href="https://github.com/AgusPalombo/ETL-APP-CV/releases/download/v0.7.4.3/EasyETL-Setup.exe"><strong>Descargar EasyETL para Windows</strong></a>
</p>
...
1. Descargá [EasyETL-Setup.exe](https://github.com/AgusPalombo/ETL-APP-CV/releases/download/v0.7.4.3/EasyETL-Setup.exe).
...
La versión publicada es **0.7.4.3 para Windows de 64 bits**.
...
### Novedades de la versión 0.7.4.3
...
- Los gráficos y las tablas dinámicas admiten hasta 30 filtros privados previos al cálculo.
...
- El Dashboard global v16 reúne indicadores, gráficos, tablas y comparaciones de distintos archivos sin mezclar sus datos.
- El sistema de seis cuadrantes conserva páginas, expansión, orden y ubicación; cada comparación ocupa dos cuadrantes contiguos.
- Las plantillas multiorigen y el informe HTML resuelven cada elemento desde su archivo correspondiente.
...
- EasyETL requiere una licencia offline válida desde el primer inicio y deja de conceder un período automático de prueba.
- El Dashboard permanece oculto y bloqueado hasta validar una licencia firmada para el equipo.
- Las licencias Ed25519 ya emitidas siguen siendo compatibles y se conservan al actualizar.
- La validación continúa siendo local, sin activación en línea, telemetría ni envío de archivos.
