...
<p align="center">
  <a href="https://github.com/AgusPalombo/ETL-APP-CV/releases/download/v0.4.4/EasyETL-Setup.exe"><strong>Descargar EasyETL para Windows</strong></a>
</p>
...
1. Descargá [EasyETL-Setup.exe](https://github.com/AgusPalombo/ETL-APP-CV/releases/download/v0.4.4/EasyETL-Setup.exe).
...
La versión actual es **0.4.4 para Windows de 64 bits**.

### Novedades de la versión 0.4.4

- Navegación de escritorio más clara y aprovechando todo el ancho.
- Constructor de gráficos plegable y más directo.
- Dashboard y exportación con menos información secundaria.
- Tarjeta personalizada limitada a columnas numéricas.
- Confirmación accesible antes de convertir el tipo de una columna.
