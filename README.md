...
<p align="center">
  <a href="https://github.com/AgusPalombo/ETL-APP-CV/releases/download/v0.4.2/EasyETL-Setup.exe"><strong>Descargar EasyETL para Windows</strong></a>
</p>
...
1. Descargá [EasyETL-Setup.exe](https://github.com/AgusPalombo/ETL-APP-CV/releases/download/v0.4.2/EasyETL-Setup.exe).
...
La versión actual es **0.4.2 para Windows de 64 bits**.
